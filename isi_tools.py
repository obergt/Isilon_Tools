...
def main():
    ...
    group.add_argument('action', help="backup/restore the object is selected on the --type flag",
                       choices=('backup', 'restore'), metavar="backup | restore --file FILE", nargs=1)
    ...
    group1.add_argument("-t", "--type", help="specifies the type of the object [shares, export, quotas].",
                        action='store', required=True, choices=('shares', 'exports', 'quotas'), metavar='TYPE')
